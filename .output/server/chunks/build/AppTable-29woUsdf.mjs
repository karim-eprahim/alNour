...
import { _ as _sfc_main$d, a as _sfc_main$2, b as _sfc_main$b, c as _sfc_main$8, d as _sfc_main$5, e as _sfc_main$9 } from './DropdownMenuTrigger-CfTxy9kg.mjs';
import { _ as _sfc_main$3 } from './index-CUpQupPt.mjs';
import { _ as _sfc_main$4 } from './Checkbox-BgWIODM0.mjs';
import { _ as _sfc_main$8$1, a as _sfc_main$6, b as _sfc_main$4$1, c as _sfc_main$1$1, d as _sfc_main$7, e as _sfc_main$5$1 } from './TableHeader-BnIov8Zr.mjs';
import { _ as __nuxt_component_1 } from './LoadingState-CjZdJj9x.mjs';
import { _ as __nuxt_component_7 } from './EmptyState-DoIe0dip.mjs';
import { _ as _sfc_main$a, a as _sfc_main$1$2, b as _sfc_main$c, c as _sfc_main$9$1, d as _sfc_main$7$1 } from './SelectValue-CvBB3u-2.mjs';
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (__props.showSearch || __props.showColumnToggle) {
        _push(`<div class="flex flex-wrap items-center justify-between gap-2 pb-4">`);
      ...
      _push(`<div class="hidden sm:block rounded-md border">`);
      ...
      _push(`</div><div class="grid gap-3 sm:hidden"><!--[-->`);
      ssrRenderList(unref(mobileRows), (item) => {
        _push(`<div class="rounded-lg border bg-card p-4">`);
        if (__props.enableExpand && item.row.getCanExpand()) {
          _push(`<div class="mb-2">`);
          _push(ssrRenderComponent(_component_UiButton, {
            variant: "ghost",
            size: "icon-xs",
            onClick: ($event) => item.row.toggleExpanded()
          }, {
            default: withCtx((_, _push2, _parent2, _scopeId) => {
              if (_push2) {
                if (!item.row.getIsExpanded()) {
                ...
                return [
                  !item.row.getIsExpanded() ? (openBlock(), createBlock(unref(ChevronRight), {
                    key: 0,
                    class: "size-4"
                  })) : (openBlock(), createBlock(unref(ChevronDown), {
                    key: 1,
        ...
        if (item.primary) {
          _push(`<div class="flex items-start justify-between gap-3"><div class="min-w-0 flex-1">`);
          ssrRenderSlot(_ctx.$slots, `cell-${item.primary.column.id}`, {
            row: item.row,
            cell: item.primary,
            getValue: item.primary.getValue
          }, () => {
            _push(ssrRenderComponent(unref(FlexRender), {
              render: item.primary.column.columnDef.cell,
              props: item.primary.getContext()
            }, null, _parent));
          }, _push, _parent);
          _push(`</div>`);
          if (item.actions) {
            _push(`<div class="shrink-0">`);
            ssrRenderSlot(_ctx.$slots, `cell-${item.actions.column.id}`, {
              row: item.row,
              cell: item.actions,
              getValue: item.actions.getValue
            }, () => {
              _push(ssrRenderComponent(unref(FlexRender), {
                render: item.actions.column.columnDef.cell,
                props: item.actions.getContext()
              }, null, _parent));
            }, _push, _parent);
            _push(`</div>`);
          } else {
        ...
        if (item.secondary.length) {
          _push(`<div class="mt-3 space-y-2 border-t pt-3"><!--[-->`);
          ssrRenderList(item.secondary, (cell) => {
            _push(`<div class="flex items-center justify-between gap-3 text-sm"><span class="shrink-0 text-xs text-muted-foreground">`);
            if (typeof cell.column.columnDef.header === "string") {
              _push(`<!--[-->${ssrInterpolate(cell.column.columnDef.header)}<!--]-->`);
            } else {
              _push(`<!---->`);
            }
            _push(`</span><span class="min-w-0 text-right">`);
            ssrRenderSlot(_ctx.$slots, `cell-${cell.column.id}`, {
              row: item.row,
              cell,
              getValue: cell.getValue
        ...
        if (__props.enableExpand && item.row.getIsExpanded()) {
          _push(`<div class="mt-3 border-t pt-3">`);
          ssrRenderSlot(_ctx.$slots, "expand", {
            row: item.row
          }, () => {
            _push(`<div class="text-muted-foreground p-4 text-center text-sm"> No expand content provided. </div>`);
          }, _push, _parent);
          _push(`</div>`);
        } else {
          _push(`<!---->`);
      ...
      if (__props.showPagination && unref(pageCount) > 0) {
        _push(`<div class="flex flex-wrap items-center justify-between gap-3 py-4"><p class="text-sm text-muted-foreground">${ssrInterpolate(unref(totalFiltered))} of ${ssrInterpolate(unref(totalData))} row(s) </p><div class="flex items-center gap-2">`);
        _push(ssrRenderComponent(_component_UiButton, {
          variant: "outline",
          size: "sm",
...
//# sourceMappingURL=AppTable-29woUsdf.mjs.map
