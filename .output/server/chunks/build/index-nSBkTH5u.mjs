...
import { _ as _sfc_main$6, b as _sfc_main$1$1, c as _sfc_main$2, a as _sfc_main$4, d as _sfc_main$3 } from './CardTitle-CZp9i7Kv.mjs';
...
import { RefreshCw, Package, TrendingUp, Wallet, HandCoins, Scale, ShoppingBag, Briefcase, Users, Truck, DollarSign, AlertTriangle, ArrowUp, ArrowDown, TrendingDown, Receipt } from '@lucide/vue';
            ...
            default: withCtx((_, _push2, _parent2, _scopeId) => {
              if (_push2) {
                ...
                _push2(ssrRenderComponent(_component_UiCardContent, null, {
                  default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                    if (_push3) {
                      _push3(`<p class="text-2xl font-bold text-green-600"${_scopeId2}>${ssrInterpolate((unref(data).financials?.totalRevenue || 0).toFixed(2))}</p><p class="text-xs text-muted-foreground"${_scopeId2}>total invoiced</p>`);
                    } else {
                      return [
                        createVNode("p", { class: "text-2xl font-bold text-green-600" }, toDisplayString((unref(data).financials?.totalRevenue || 0).toFixed(2)), 1),
                        createVNode("p", { class: "text-xs text-muted-foreground" }, "total invoiced")
                      ];
                    }
                  }),
                  _: 1
            ...
            default: withCtx((_, _push2, _parent2, _scopeId) => {
              if (_push2) {
                      ...
                      _push3(ssrRenderComponent(_component_UiCardTitle, { class: "text-sm font-medium text-muted-foreground" }, {
                        default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                          if (_push4) {
                            ...
                            return [
                              createTextVNode("Cash & Bank")
                            ];
                          }
                        }),
                        _: 1
                      }, _parent3, _scopeId2));
                      _push3(ssrRenderComponent(unref(Wallet), { class: "size-4 text-blue-500" }, null, _parent3, _scopeId2));
                    } else {
                      return [
                        createVNode(_component_UiCardTitle, { class: "text-sm font-medium text-muted-foreground" }, {
                          default: withCtx(() => [
                        ...
                        createVNode(unref(Wallet), { class: "size-4 text-blue-500" })
                      ];
                    }
                  }),
                  _: 1
                ...
                _push2(ssrRenderComponent(_component_UiCardContent, null, {
                  default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                    if (_push3) {
                      _push3(`<p class="text-2xl font-bold text-blue-600"${_scopeId2}>${ssrInterpolate((unref(data).financials?.companyCash || 0).toFixed(2))}</p><p class="text-xs text-muted-foreground"${_scopeId2}>money with the company</p>`);
                    } else {
                      return [
                        createVNode("p", { class: "text-2xl font-bold text-blue-600" }, toDisplayString((unref(data).financials?.companyCash || 0).toFixed(2)), 1),
                        createVNode("p", { class: "text-xs text-muted-foreground" }, "money with the company")
                      ];
                    }
                  }),
                  _: 1
            ...
            default: withCtx((_, _push2, _parent2, _scopeId) => {
              if (_push2) {
                ...
                _push2(ssrRenderComponent(_component_UiCardContent, null, {
                  default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                    if (_push3) {
                      _push3(`<p class="text-2xl font-bold text-amber-600 dark:text-amber-400"${_scopeId2}>${ssrInterpolate((unref(data).financials?.distributorCustody || 0).toFixed(2))}</p><p class="text-xs text-muted-foreground"${_scopeId2}>${ssrInterpolate(unref(data).financials?.distributorsWithCustody || 0)} distributor(s)</p>`);
                    } else {
                      return [
                        createVNode("p", { class: "text-2xl font-bold text-amber-600 dark:text-amber-400" }, toDisplayString((unref(data).financials?.distributorCustody || 0).toFixed(2)), 1),
                        createVNode("p", { class: "text-xs text-muted-foreground" }, toDisplayString(unref(data).financials?.distributorsWithCustody || 0) + " distributor(s)", 1)
                      ];
                    }
                  }),
                  _: 1
                    ...
                    if (_push3) {
                      ...
                      if (unref(data).distributor.custodies?.length) {
                        ...
                        ssrRenderList(unref(data).distributor.custodies, (c) => {
                          _push3(`<div class="flex justify-between text-xs"${_scopeId2}><span class="text-muted-foreground"${_scopeId2}>${ssrInterpolate(c.productName)}</span><span class="font-medium tabular-nums"${_scopeId2}>${ssrInterpolate(Number(c.quantity).toFixed(3))}</span></div>`);
                        });
                        _push3(`<!--]--></div>`);
                      } else {
                        _push3(`<!---->`);
                        ...
                        unref(data).distributor.custodies?.length ? (openBlock(), createBlock("div", {
                          ...
                          (openBlock(true), createBlock(Fragment, null, renderList(unref(data).distributor.custodies, (c) => {
                            return openBlock(), createBlock("div", {
                              ...
                              createVNode("span", { class: "font-medium tabular-nums" }, toDisplayString(Number(c.quantity).toFixed(3)), 1)
                            ]);
                          }), 128))
                    ...
                    if (_push3) {
                      ...
                      if (unref(data).goodsInTransit.byDistributor?.length) {
                        ...
                        ssrRenderList(unref(data).goodsInTransit.byDistributor, (d) => {
                          _push3(`<div class="rounded-lg border p-3"${_scopeId2}><div class="flex items-center justify-between mb-1"${_scopeId2}><p class="text-sm font-medium"${_scopeId2}>${ssrInterpolate(d.name)}</p><span class="text-sm font-bold tabular-nums"${_scopeId2}>${ssrInterpolate(Number(d.totalQty).toFixed(3))}</span></div><div class="space-y-0.5"${_scopeId2}><!--[-->`);
                          ssrRenderList(d.products, (p) => {
                            _push3(`<div class="flex justify-between text-xs text-muted-foreground pl-2"${_scopeId2}><span${_scopeId2}>${ssrInterpolate(p.name)}</span><span class="tabular-nums"${_scopeId2}>${ssrInterpolate(Number(p.qty).toFixed(3))}</span></div>`);
                          });
                          _push3(`<!--]--></div></div>`);
                        });
                        _push3(`<!--]--></div>`);
                          ...
                          (openBlock(true), createBlock(Fragment, null, renderList(unref(data).goodsInTransit.byDistributor, (d) => {
                            return openBlock(), createBlock("div", {
                              ...
                              createVNode("div", { class: "flex items-center justify-between mb-1" }, [
                                ...
                                createVNode("span", { class: "text-sm font-bold tabular-nums" }, toDisplayString(Number(d.totalQty).toFixed(3)), 1)
                              ]),
                              createVNode("div", { class: "space-y-0.5" }, [
                                (openBlock(true), createBlock(Fragment, null, renderList(d.products, (p) => {
                                  return openBlock(), createBlock("div", {
                                    ...
                                    createVNode("span", { class: "tabular-nums" }, toDisplayString(Number(p.qty).toFixed(3)), 1)
                                  ]);
                                }), 128))
                              ])
                            ]);
                ...
                _push2(ssrRenderComponent(_component_UiCardContent, null, {
                  default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                    if (_push3) {
                      ...
                      _push3(` Revenue</p><p class="text-xl font-bold text-green-600"${_scopeId2}>${ssrInterpolate(unref(data).financials.totalRevenue.toFixed(2))}</p><p class="text-xs text-muted-foreground"${_scopeId2}>Cash &amp; Bank: ${ssrInterpolate(Number(unref(data).financials.companyCash || 0).toFixed(2))} · Custody: ${ssrInterpolate(Number(unref(data).financials.distributorCustody || 0).toFixed(2))}</p></div><div class="rounded-lg border p-4"${_scopeId2}><p class="text-sm text-muted-foreground flex items-center gap-1"${_scopeId2}>`);
                      _push3(ssrRenderComponent(unref(TrendingDown), { class: "size-3.5" }, null, _parent3, _scopeId2));
                      _push3(` COGS</p><p class="text-xl font-bold text-amber-600"${_scopeId2}>${ssrInterpolate(Number(unref(data).financials.totalCogs).toFixed(2))}</p><p class="text-xs text-muted-foreground"${_scopeId2}>Raw materials consumed</p></div><div class="rounded-lg border p-4"${_scopeId2}><p class="text-sm text-muted-foreground flex items-center gap-1"${_scopeId2}>`);
                      _push3(ssrRenderComponent(unref(Briefcase), { class: "size-3.5" }, null, _parent3, _scopeId2));
                      _push3(` Labor Costs</p><p class="text-xl font-bold text-orange-600"${_scopeId2}>${ssrInterpolate(Number(unref(data).financials.totalLaborCosts).toFixed(2))}</p><p class="text-xs text-muted-foreground"${_scopeId2}>Worker daily wages</p></div><div class="rounded-lg border p-4"${_scopeId2}><p class="text-sm text-muted-foreground flex items-center gap-1"${_scopeId2}>`);
                      _push3(ssrRenderComponent(unref(Receipt), { class: "size-3.5" }, null, _parent3, _scopeId2));
                      _push3(` Expenses</p><p class="text-xl font-bold text-destructive"${_scopeId2}>${ssrInterpolate(Number(unref(data).financials.totalExpenses).toFixed(2))}</p><p class="text-xs text-muted-foreground"${_scopeId2}>Operating expenses</p></div><div class="rounded-lg border p-4"${_scopeId2}><p class="text-sm text-muted-foreground flex items-center gap-1"${_scopeId2}>`);
                      _push3(ssrRenderComponent(unref(Scale), { class: "size-3.5" }, null, _parent3, _scopeId2));
                      _push3(` Gross Profit</p><p class="${ssrRenderClass([unref(data).financials.grossProfit >= 0 ? "text-green-600" : "text-destructive", "text-xl font-bold"])}"${_scopeId2}>${ssrInterpolate(Number(unref(data).financials.grossProfit).toFixed(2))}</p><p class="text-xs text-muted-foreground"${_scopeId2}>Revenue − COGS</p></div><div class="rounded-lg border p-4"${_scopeId2}><p class="text-sm text-muted-foreground flex items-center gap-1"${_scopeId2}>`);
                      _push3(ssrRenderComponent(unref(Scale), { class: "size-3.5" }, null, _parent3, _scopeId2));
                      _push3(` Net Profit</p><p class="${ssrRenderClass([unref(data).financials.netProfit >= 0 ? "text-green-600" : "text-destructive", "text-xl font-bold"])}"${_scopeId2}>${ssrInterpolate(Number(unref(data).financials.netProfit).toFixed(2))}</p><p class="text-xs text-muted-foreground"${_scopeId2}>Gross − Labor − Expenses</p></div></div>`);
                    } else {
                      return [
                        createVNode("div", { class: "grid gap-4 sm:grid-cols-2 lg:grid-cols-4" }, [
                          createVNode("div", { class: "rounded-lg border p-4" }, [
                            ...
                            createVNode("p", { class: "text-xs text-muted-foreground" }, "Cash & Bank: " + toDisplayString(Number(unref(data).financials.companyCash || 0).toFixed(2)) + " · Custody: " + toDisplayString(Number(unref(data).financials.distributorCustody || 0).toFixed(2)), 1)
                          ]),
                          createVNode("div", { class: "rounded-lg border p-4" }, [
                            createVNode("p", { class: "text-sm text-muted-foreground flex items-center gap-1" }, [
                            ...
                            createVNode("p", { class: "text-xl font-bold text-amber-600" }, toDisplayString(Number(unref(data).financials.totalCogs).toFixed(2)), 1),
                          ...
                          createVNode("div", { class: "rounded-lg border p-4" }, [
                            ...
                            createVNode("p", { class: "text-xl font-bold text-orange-600" }, toDisplayString(Number(unref(data).financials.totalLaborCosts).toFixed(2)), 1),
                          ...
                          createVNode("div", { class: "rounded-lg border p-4" }, [
                            ...
                            createVNode("p", { class: "text-xl font-bold text-destructive" }, toDisplayString(Number(unref(data).financials.totalExpenses).toFixed(2)), 1),
                          ...
                          createVNode("div", { class: "rounded-lg border p-4" }, [
                            ...
                            }, toDisplayString(Number(unref(data).financials.grossProfit).toFixed(2)), 3),
                          ...
                          createVNode("div", { class: "rounded-lg border p-4" }, [
                            ...
                            }, toDisplayString(Number(unref(data).financials.netProfit).toFixed(2)), 3),
...
//# sourceMappingURL=index-nSBkTH5u.mjs.map
