...
import { _ as _sfc_main$6, b as _sfc_main$1$1, a as _sfc_main$4, c as _sfc_main$3, d as _sfc_main$3$1 } from './CardTitle-CZp9i7Kv.mjs';
import { _ as _sfc_main$2 } from './index-BJ9JiLtz.mjs';
                ...
                default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    ...
                    ssrRenderList(unref(invoice).items || [], (item) => {
                      _push3(`<div class="grid grid-cols-4 gap-2 border-b px-3 py-2 text-sm last:border-0"${_scopeId2}><span class="col-span-2 truncate"${_scopeId2}>${ssrInterpolate(item.product?.name || item.productId)}</span><span class="text-right"${_scopeId2}>${ssrInterpolate(Number(item.quantity).toFixed(1))}</span><span class="text-right font-medium"${_scopeId2}>${ssrInterpolate(item.totalPrice.toFixed(2))}</span></div>`);
                    });
...
//# sourceMappingURL=_id_-pVQ6DuHX.mjs.map
