import { _ as _sfc_main$6, b as _sfc_main$1$1, c as _sfc_main$7, d as _sfc_main$3$1, a as _sfc_main$4$1 } from './CardTitle-D6ZW0MPQ.mjs';
import { _ as _sfc_main$1$2, a as _sfc_main$8 } from './RadioGroupItem-DYdhvY_e.mjs';
import { defineComponent, mergeProps, withCtx, createTextVNode, createVNode, computed, unref, openBlock, createBlock, Fragment, renderList, resolveDynamicComponent, toDisplayString, useSSRContext } from 'vue';
...
import { j as useTheme, c as cn } from './server.mjs';
          ...
          if (_push2) {
            ...
            return [
              (openBlock(true), createBlock(Fragment, null, renderList(unref(themes), (t) => {
                return openBlock(), createBlock(_component_UiRadioGroupItem, {
                  key: t,
                  "as-child": "",
                  value: t,
                  "aria-label": `${t} theme`
          ...
          if (_push2) {
            ...
            ssrRenderList(options, (opt) => {
              _push2(ssrRenderComponent(_component_UiRadioGroupItem, {
                ...
                default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    _push3(`<div class="${ssrRenderClass(unref(cn)(
                      "flex w-full items-center justify-center gap-2 rounded-lg border px-3 py-2.5 text-sm font-medium transition-colors",
                      isSelected(opt.value) ? "border-primary bg-primary text-primary-foreground" : "border-border text-muted-foreground hover:bg-accent/50 hover:text-accent-foreground"
                    ))}"${_scopeId2}>`);
                    ssrRenderVNode(_push3, createVNode(resolveDynamicComponent(opt.icon), {
                      class: "size-4",
                      "aria-hidden": "true"
                    }, null), _parent3, _scopeId2);
                    _push3(` ${ssrInterpolate(opt.label)}</div>`);
                  } else {
                    return [
                      createVNode("div", {
                        class: unref(cn)(
            ...
            return [
              (openBlock(), createBlock(Fragment, null, renderList(options, (opt) => {
                return createVNode(_component_UiRadioGroupItem, {
                  key: opt.value,
                  "as-child": "",
                  value: opt.value,
                  "aria-label": opt.label
                ...
                default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    _push3(`<div class="${ssrRenderClass(unref(cn)(
                      "flex w-full items-center justify-center gap-2 rounded-lg border px-3 py-2.5 text-sm font-medium transition-colors",
                      isSelected(opt.value) ? "border-primary bg-primary text-primary-foreground" : "border-border text-muted-foreground hover:bg-accent/50 hover:text-accent-foreground"
                    ))}"${_scopeId2}><span class="${ssrRenderClass([isSelected(opt.value) ? "border-current" : "border-muted-foreground/40", "size-3 rounded-full border-2"])}" style="${ssrRenderStyle({ borderRadius: unref(radiusOptions)[opt.value] })}" aria-hidden="true"${_scopeId2}></span> ${ssrInterpolate(opt.label)}</div>`);
                  } else {
                    return [
                      createVNode("div", {
                        class: unref(cn)(
                        ...
                        createVNode("span", {
                          class: ["size-3 rounded-full border-2", isSelected(opt.value) ? "border-current" : "border-muted-foreground/40"],
                          style: { borderRadius: unref(radiusOptions)[opt.value] },
                          "aria-hidden": "true"
                        }, null, 6),
                        createTextVNode(" " + toDisplayString(opt.label), 1)
                      ], 2)
...
//# sourceMappingURL=appearance-DffLil8d.mjs.map
