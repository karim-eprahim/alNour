...
import { useForwardPropsEmits, DropdownMenuRoot, useForwardProps, DropdownMenuTrigger, DropdownMenuPortal, DropdownMenuContent, DropdownMenuLabel, DropdownMenuSeparator, DropdownMenuItem, DropdownMenuCheckboxItem, DropdownMenuItemIndicator, DropdownMenuGroup, DropdownMenuRadioGroup, DropdownMenuRadioItem, DropdownMenuSub, DropdownMenuSubContent, DropdownMenuSubTrigger } from 'reka-ui';
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(ssrRenderComponent(unref(DropdownMenuLabel), mergeProps({
        ...
        class: unref(cn)("text-muted-foreground px-1.5 py-1 text-xs font-medium data-inset:pl-7", props.class)
      }, _attrs), {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ssrRenderSlot(_ctx.$slots, "default", {}, null, _push2, _parent2, _scopeId);
...
export { _sfc_main$d as _, _sfc_main as a, _sfc_main$b as b, _sfc_main$8 as c, _sfc_main$5 as d, _sfc_main$9 as e };
//# sourceMappingURL=DropdownMenuTrigger-MlqyivDB.mjs.map
