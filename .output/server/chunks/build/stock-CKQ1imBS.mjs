...
import { _ as _sfc_main$6, a as _sfc_main$4 } from './CardTitle-CZp9i7Kv.mjs';
import { _ as _sfc_main$8, a as _sfc_main$2, b as _sfc_main$4$1, c as _sfc_main$1$1, d as _sfc_main$7, e as _sfc_main$5 } from './TableHeader-BnIov8Zr.mjs';
                                    ...
                                    default: withCtx((_5, _push6, _parent6, _scopeId5) => {
                                      if (_push6) {
                                        ...
                                        _push6(ssrRenderComponent(_component_UiTableCell, { class: "text-right font-medium" }, {
                                          default: withCtx((_6, _push7, _parent7, _scopeId6) => {
                                            if (_push7) {
                                              _push7(`${ssrInterpolate(Number(item.quantity).toFixed(1))}`);
                                            } else {
                                              return [
                                                createTextVNode(toDisplayString(Number(item.quantity).toFixed(1)), 1)
                                              ];
                                            }
                                          }),
                                          _: 2
                                        ...
                                        _push6(ssrRenderComponent(_component_UiTableCell, { class: "text-right" }, {
                                          default: withCtx((_6, _push7, _parent7, _scopeId6) => {
                                            if (_push7) {
                                              _push7(`${ssrInterpolate(Number(item.product.sellingPrice)?.toFixed(2) || "—")}`);
                                            } else {
                                              return [
                                                createTextVNode(toDisplayString(Number(item.product.sellingPrice)?.toFixed(2) || "—"), 1)
                                              ];
                                            }
                                          }),
                                          _: 2
                                        ...
                                        _push6(ssrRenderComponent(_component_UiTableCell, { class: "text-right font-semibold" }, {
                                          default: withCtx((_6, _push7, _parent7, _scopeId6) => {
                                            if (_push7) {
                                              _push7(`${ssrInterpolate((Number(item.quantity) * (Number(item.product.sellingPrice) || 0)).toFixed(2))}`);
                                            } else {
                                              return [
                                                createTextVNode(toDisplayString((Number(item.quantity) * (Number(item.product.sellingPrice) || 0)).toFixed(2)), 1)
                                              ];
                                            }
                                          }),
                                          _: 2
                ...
                _push2(ssrRenderComponent(_component_UiCardContent, { class: "flex items-start gap-3 p-4" }, {
                  default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                    if (_push3) {
                      ...
                      _push3(`</div><div class="min-w-0 flex-1"${_scopeId2}><p class="text-sm font-medium truncate"${_scopeId2}>${ssrInterpolate(item.product.name)}</p><p class="text-xs text-muted-foreground truncate"${_scopeId2}>${ssrInterpolate(item.product.nameAr)}</p><div class="mt-2 flex items-center justify-between"${_scopeId2}><span class="text-xs text-muted-foreground"${_scopeId2}>Qty: <strong${_scopeId2}>${ssrInterpolate(Number(item.quantity).toFixed(1))}</strong></span><span class="text-xs text-muted-foreground"${_scopeId2}>Price: <strong${_scopeId2}>${ssrInterpolate(Number(item.product.sellingPrice)?.toFixed(2) || "—")}</strong></span></div><p class="mt-1 text-sm font-semibold"${_scopeId2}>Total: ${ssrInterpolate((Number(item.quantity) * (Number(item.product.sellingPrice) || 0)).toFixed(2))}</p></div>`);
                    } else {
                      return [
                        ...
                        createVNode("div", { class: "min-w-0 flex-1" }, [
                          ...
                          createVNode("div", { class: "mt-2 flex items-center justify-between" }, [
                            createVNode("span", { class: "text-xs text-muted-foreground" }, [
                              createTextVNode("Qty: "),
                              createVNode("strong", null, toDisplayString(Number(item.quantity).toFixed(1)), 1)
                            ]),
                            createVNode("span", { class: "text-xs text-muted-foreground" }, [
                              createTextVNode("Price: "),
                              createVNode("strong", null, toDisplayString(Number(item.product.sellingPrice)?.toFixed(2) || "—"), 1)
                            ])
                          ]),
                          createVNode("p", { class: "mt-1 text-sm font-semibold" }, "Total: " + toDisplayString((Number(item.quantity) * (Number(item.product.sellingPrice) || 0)).toFixed(2)), 1)
                        ])
                      ];
                    }
                  }),
...
//# sourceMappingURL=stock-CKQ1imBS.mjs.map
