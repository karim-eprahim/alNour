import { _ as _sfc_main$1 } from './Input-BT7sGQjY.mjs';
import { _ as __nuxt_component_1 } from './LoadingState-CjZdJj9x.mjs';
import { _ as _sfc_main$2 } from './index-CUpQupPt.mjs';
import { _ as _sfc_main$6, a as _sfc_main$4, b as _sfc_main$1$1, c as _sfc_main$7 } from './CardTitle-CZp9i7Kv.mjs';
import { _ as _sfc_main$3 } from './Label-C-S6OHzh.mjs';
import { _ as _sfc_main$5 } from './Textarea-Cs62HpDa.mjs';
import { _ as __nuxt_component_3 } from './LookupCombobox-B5GN9aF8.mjs';
import { _ as _sfc_main$a, a as _sfc_main$1$2, b as _sfc_main$8, c as _sfc_main$9, d as _sfc_main$7$1 } from './SelectValue-CvBB3u-2.mjs';
import { defineComponent, ref, reactive, computed, mergeProps, unref, isRef, withCtx, createVNode, createTextVNode, toDisplayString, openBlock, createBlock, Fragment, renderList, useSSRContext } from 'vue';
import { ssrRenderAttrs, ssrRenderComponent, ssrRenderList, ssrInterpolate, ssrRenderClass } from 'vue/server-renderer';
import { Search, Clock, Users, UserPlus, ShoppingCart, ArrowLeft, Plus, X, DollarSign } from '@lucide/vue';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (!unref(showSaleForm) && !unref(showCreateSheet)) {
        ...
        _push(`</div>`);
        if (unref(recentCustomers).length > 0 && !unref(customerSearch) && unref(customers).length === 0) {
          _push(`<div class="mb-6"><h3 class="flex items-center gap-1 text-sm font-medium text-muted-foreground mb-2">`);
          _push(ssrRenderComponent(unref(Clock), { class: "size-3.5" }, null, _parent));
          _push(` Recent Customers </h3><div class="space-y-1"><!--[-->`);
          ssrRenderList(unref(recentCustomers), (c) => {
            _push(`<button class="w-full flex items-center justify-between rounded-lg border px-4 py-3 text-sm transition-colors hover:bg-accent/50"><div class="text-left"><p class="font-medium">${ssrInterpolate(c.name)}</p><p class="text-xs text-muted-foreground">${ssrInterpolate(c.phone || "—")}</p></div><div class="text-right"><p class="text-xs text-muted-foreground">${ssrInterpolate(new Date(c.lastVisit).toLocaleDateString())}</p><p class="${ssrRenderClass([(c.balance || 0) > 0 ? "text-green-600" : "", "text-xs font-medium"])}">${ssrInterpolate((c.balance || 0).toFixed(2))}</p></div></button>`);
          });
          _push(`<!--]--></div></div>`);
        } else {
          _push(`<!---->`);
        ...
        if (unref(customerLoading)) {
          ...
          _push(`</div>`);
        } else if (unref(customerSearch) && unref(customers).length === 0 && !unref(customerLoading)) {
          ...
          _push(`<p class="text-sm text-muted-foreground mb-3">No customers found</p>`);
          _push(ssrRenderComponent(_component_UiButton, {
            size: "sm",
            variant: "outline",
            onClick: ($event) => showCreateSheet.value = true
          }, {
            default: withCtx((_, _push2, _parent2, _scopeId) => {
              if (_push2) {
                _push2(ssrRenderComponent(unref(UserPlus), { class: "size-4" }, null, _parent2, _scopeId));
                _push2(` Create &quot;${ssrInterpolate(unref(customerSearch))}&quot; `);
              } else {
                return [
                  createVNode(unref(UserPlus), { class: "size-4" }),
          ...
          _push(`</div>`);
        } else if (!unref(customerSearch) && unref(recentCustomers).length === 0 && unref(customers).length === 0) {
          _push(`<div class="text-center py-8 text-sm text-muted-foreground">`);
          _push(ssrRenderComponent(unref(Users), { class: "mx-auto mb-2 size-8 text-muted-foreground/60" }, null, _parent));
          _push(`<p>No customers yet</p>`);
          _push(ssrRenderComponent(_component_UiButton, {
            size: "sm",
            class: "mt-3",
            onClick: ($event) => showCreateSheet.value = true
        ...
        _push(`</div>`);
      } else if (unref(showCreateSheet)) {
        _push(`<div class="max-w-md mx-auto space-y-6"><div class="flex items-center gap-3">`);
        _push(ssrRenderComponent(_component_UiButton, {
          variant: "ghost",
          size: "icon",
          class: "size-8 shrink-0",
          onClick: ($event) => showCreateSheet.value = false
        }, {
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
        ...
        _push(`<div><h2 class="text-lg font-semibold">New Customer</h2></div></div>`);
        _push(ssrRenderComponent(_component_UiCard, null, {
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(ssrRenderComponent(_component_UiCardContent, { class: "space-y-4 pt-6" }, {
                default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    ...
                    _push3(ssrRenderComponent(_component_UiButton, {
                      ...
                      default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                        if (_push4) {
                          _push4(`${ssrInterpolate(unref(creatingCustomer) ? "Creating..." : "Create & Continue")}`);
                        } else {
                          return [
                            createTextVNode(toDisplayString(unref(creatingCustomer) ? "Creating..." : "Create & Continue"), 1)
                          ];
                        }
                      }),
                      _: 1
              ...
              return [
                createVNode(_component_UiCardContent, { class: "space-y-4 pt-6" }, {
                  default: withCtx(() => [
                    createVNode("div", null, [
                      createVNode(_component_UiLabel, null, {
                        default: withCtx(() => [
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/distributor/customers/index.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};

export { _sfc_main as default };
//# sourceMappingURL=index-Bsxs4cFH.mjs.map
