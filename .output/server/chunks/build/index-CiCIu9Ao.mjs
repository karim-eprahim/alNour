...
import { _ as _sfc_main$6, b as _sfc_main$1$1, c as _sfc_main$2, a as _sfc_main$4, d as _sfc_main$3 } from './CardTitle-D6ZW0MPQ.mjs';
                ...
                _push2(ssrRenderComponent(_component_UiCardContent, null, {
                  default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                    if (_push3) {
                      ...
                      _push3(` Revenue</p><p class="text-xl font-bold text-green-600"${_scopeId2}>${ssrInterpolate(Number(unref(data).financials.totalRevenue).toFixed(2))}</p><p class="text-xs text-muted-foreground"${_scopeId2}>${ssrInterpolate(Number(unref(data).financials.totalCollected).toFixed(2))} collected</p></div><div class="rounded-lg border p-4"${_scopeId2}><p class="text-sm text-muted-foreground flex items-center gap-1"${_scopeId2}>`);
                      ...
                      return [
                        createVNode("div", { class: "grid gap-4 sm:grid-cols-2 lg:grid-cols-4" }, [
                          createVNode("div", { class: "rounded-lg border p-4" }, [
                            ...
                            createVNode("p", { class: "text-xl font-bold text-green-600" }, toDisplayString(Number(unref(data).financials.totalRevenue).toFixed(2)), 1),
                            createVNode("p", { class: "text-xs text-muted-foreground" }, toDisplayString(Number(unref(data).financials.totalCollected).toFixed(2)) + " collected", 1)
                          ]),
                          createVNode("div", { class: "rounded-lg border p-4" }, [
                            createVNode("p", { class: "text-sm text-muted-foreground flex items-center gap-1" }, [
...
//# sourceMappingURL=index-CiCIu9Ao.mjs.map
