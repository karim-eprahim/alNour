...
import { _ as _sfc_main$a } from './index-BJ9JiLtz.mjs';
...
import { _ as _sfc_main$6, b as _sfc_main$1$1, c as _sfc_main$2, d as _sfc_main$3, a as _sfc_main$4 } from './CardTitle-CZp9i7Kv.mjs';
    ...
    const columns = [
      {
        accessorKey: "name",
        header: "Name",
        cell: ({ row }) => h(__nuxt_component_0, { to: `/customers/distributors/${row.original.id}`, class: "font-medium hover:underline" }, row.original.name)
      },
      {
        accessorKey: "phone",
        header: "Phone",
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/customers/distributors/index.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};

export { _sfc_main as default };
//# sourceMappingURL=index-BCGFUGb0.mjs.map
