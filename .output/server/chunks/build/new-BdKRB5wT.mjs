...
import { _ as _sfc_main$1$2, a as _sfc_main$5 } from './RadioGroupItem-yMIpcpyE.mjs';
import { _ as _sfc_main$7 } from './Label-C-S6OHzh.mjs';
import { _ as __nuxt_component_3 } from './LookupCombobox-B5GN9aF8.mjs';
import { _ as _sfc_main$8 } from './Separator-BNaUuv25.mjs';
import { _ as _sfc_main$9 } from './Input-BT7sGQjY.mjs';
import { _ as _sfc_main$a, a as _sfc_main$1$3, b as _sfc_main$b, c as _sfc_main$9$1, d as _sfc_main$7$1 } from './SelectValue-CvBB3u-2.mjs';
import { _ as __nuxt_component_7 } from './EmptyState-DoIe0dip.mjs';
import { _ as _sfc_main$8$1, a as _sfc_main$c, b as _sfc_main$4$1, c as _sfc_main$1$4, d as _sfc_main$7$2, e as _sfc_main$5$1 } from './TableHeader-BnIov8Zr.mjs';
import { n as navigateTo } from './server.mjs';
import { defineComponent, ref, reactive, watch, computed, mergeProps, unref, withCtx, createVNode, createTextVNode, isRef, openBlock, createBlock, Fragment, toDisplayString, createCommentVNode, renderList, useSSRContext } from 'vue';
import { ssrRenderAttrs, ssrRenderComponent, ssrRenderClass, ssrInterpolate, ssrRenderList } from 'vue/server-renderer';
import { ArrowLeft, Store, Truck, CalendarDays, Plus, X, ShoppingCart } from '@lucide/vue';
import { P as PageHeader } from './PageHeader-CZERfSxB.mjs';
import { b as fetchCustomersLookupApi, e as fetchDistributorsLookupApi } from './api-BZnrPRgb.mjs';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const fulfillmentMethod = ref("DIRECT");
    const form = reactive({
      customerId: "",
      warehouseId: "",
      paidAmount: 0,
    ...
    computed(() => {
      ...
      if (fulfillmentMethod.value === "DELIVERY") {
        return {
          ...
          deliveryNotes: form.deliveryNotes || void 0,
          items
        };
      }
      return {
        ...
        paymentNotes: form.paymentNotes || void 0
      };
    });
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      const _component_UiRadioGroupItem = _sfc_main$5;
      ...
      _push(ssrRenderComponent(PageHeader, {
        title: "New Sale",
        description: "Create a direct sale or a delivery order"
      }, null, _parent));
      _push(`</div><form>`);
                ...
                if (_push3) {
                  _push3(ssrRenderComponent(_component_UiCardTitle, null, {
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(`Fulfillment Method`);
                      } else {
                        return [
                          createTextVNode("Fulfillment Method")
                        ];
                      }
                    }),
                    _: 1
                  ...
                  _push3(ssrRenderComponent(_component_UiCardDescription, null, {
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(`Choose how this sale will be fulfilled`);
                      } else {
                        return [
                          createTextVNode("Choose how this sale will be fulfilled")
                        ];
                      }
                    }),
                    _: 1
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(ssrRenderComponent(_component_UiRadioGroup, {
                    modelValue: unref(fulfillmentMethod),
                    "onUpdate:modelValue": ($event) => isRef(fulfillmentMethod) ? fulfillmentMethod.value = $event : null,
                    class: "grid gap-3 sm:grid-cols-2"
                  }, {
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(`<label class="${ssrRenderClass([unref(fulfillmentMethod) === "DIRECT" ? "border-primary bg-primary/5" : "hover:bg-muted", "flex cursor-pointer items-start gap-3 rounded-lg border p-4 transition-colors"])}"${_scopeId3}>`);
                        ...
                        _push4(ssrRenderComponent(unref(Store), { class: "size-4" }, null, _parent4, _scopeId3));
                        _push4(` Customer Pickup </span><span class="mt-1 block text-xs text-muted-foreground"${_scopeId3}>Direct sale — customer takes the items immediately</span></span></label><label class="${ssrRenderClass([unref(fulfillmentMethod) === "DELIVERY" ? "border-primary bg-primary/5" : "hover:bg-muted", "flex cursor-pointer items-start gap-3 rounded-lg border p-4 transition-colors"])}"${_scopeId3}>`);
                        _push4(ssrRenderComponent(_component_UiRadioGroupItem, {
                          id: "fm-delivery",
                          value: "DELIVERY",
                          class: "mt-0.5"
                        ...
                        _push4(`<span${_scopeId3}><span class="flex items-center gap-2 font-medium"${_scopeId3}>`);
                        _push4(ssrRenderComponent(unref(Truck), { class: "size-4" }, null, _parent4, _scopeId3));
                        _push4(` Distributor Delivery </span><span class="mt-1 block text-xs text-muted-foreground"${_scopeId3}>Delivery order — assigned to a distributor</span></span></label>`);
                      } else {
                        return [
                          createVNode("label", {
                            class: ["flex cursor-pointer items-start gap-3 rounded-lg border p-4 transition-colors", unref(fulfillmentMethod) === "DIRECT" ? "border-primary bg-primary/5" : "hover:bg-muted"]
                          }, [
                            ...
                            createVNode("span", null, [
                              createVNode("span", { class: "flex items-center gap-2 font-medium" }, [
                                createVNode(unref(Store), { class: "size-4" }),
                                createTextVNode(" Customer Pickup ")
                              ]),
                              createVNode("span", { class: "mt-1 block text-xs text-muted-foreground" }, "Direct sale — customer takes the items immediately")
                            ])
                          ], 2),
                          createVNode("label", {
                            class: ["flex cursor-pointer items-start gap-3 rounded-lg border p-4 transition-colors", unref(fulfillmentMethod) === "DELIVERY" ? "border-primary bg-primary/5" : "hover:bg-muted"]
                          }, [
                            createVNode(_component_UiRadioGroupItem, {
                              id: "fm-delivery",
                              value: "DELIVERY",
                            ...
                            createVNode("span", null, [
                              createVNode("span", { class: "flex items-center gap-2 font-medium" }, [
                                createVNode(unref(Truck), { class: "size-4" }),
                                createTextVNode(" Distributor Delivery ")
                              ]),
                              createVNode("span", { class: "mt-1 block text-xs text-muted-foreground" }, "Delivery order — assigned to a distributor")
                            ])
                          ], 2)
                        ];
                      }
      ...
      _push(`<div class="grid gap-6 lg:grid-cols-2 mt-6">`);
      _push(ssrRenderComponent(_component_UiCard, null, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(_component_UiCardHeader, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  ...
                  _push3(ssrRenderComponent(_component_UiCardDescription, null, {
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(`Customer, warehouse, and fulfillment info`);
                      } else {
                        return [
                          createTextVNode("Customer, warehouse, and fulfillment info")
                        ];
                      }
                    }),
                    _: 1
            ...
            _push2(ssrRenderComponent(_component_UiCardContent, { class: "space-y-4" }, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  ...
                  if (unref(fulfillmentMethod) === "DIRECT") {
                    _push3(`<!--[--><div class="space-y-2"${_scopeId2}>`);
                    ...
                    _push3(`<!--[--><div class="space-y-2"${_scopeId2}>`);
                    _push3(ssrRenderComponent(_component_UiLabel, { for: "assignedDistributor" }, {
                      default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                        if (_push4) {
                          _push4(`Assign Distributor *`);
                        } else {
                          return [
                            createTextVNode("Assign Distributor *")
                          ];
                        }
                      }),
                      _: 1
                    ...
                    _push3(ssrRenderComponent(_component_LookupCombobox, {
                      modelValue: unref(form).assignedDistributorId,
                      "onUpdate:modelValue": ($event) => unref(form).assignedDistributorId = $event,
                      endpoint: unref(fetchDistributorsLookupApi),
                      placeholder: "Select distributor..."
                    }, null, _parent3, _scopeId2));
                    _push3(`</div><div class="space-y-2"${_scopeId2}>`);
                    _push3(ssrRenderComponent(_component_UiLabel, { for: "expectedDeliveryDate" }, {
                      default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                        if (_push4) {
                          _push4(`<span class="inline-flex items-center gap-1.5"${_scopeId3}>`);
                          _push4(ssrRenderComponent(unref(CalendarDays), { class: "size-3.5" }, null, _parent4, _scopeId3));
                          _push4(` Expected Delivery Date *</span>`);
                        } else {
                          return [
                            createVNode("span", { class: "inline-flex items-center gap-1.5" }, [
                              createVNode(unref(CalendarDays), { class: "size-3.5" }),
                              createTextVNode(" Expected Delivery Date *")
                            ])
                          ];
                        }
                      }),
                    ...
                    _push3(ssrRenderComponent(_component_UiInput, {
                      ...
                      modelValue: unref(form).expectedDeliveryDate,
                      "onUpdate:modelValue": ($event) => unref(form).expectedDeliveryDate = $event,
                      type: "date"
                    }, null, _parent3, _scopeId2));
                    _push3(`</div><div class="space-y-2"${_scopeId2}>`);
                    ...
                    _push3(ssrRenderComponent(_component_UiRadioGroup, {
                      ...
                      default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                        if (_push4) {
                          _push4(`<label class="flex cursor-pointer items-center gap-2 text-sm"${_scopeId3}>`);
                          _push4(ssrRenderComponent(_component_UiRadioGroupItem, {
                            id: "priority-normal",
                            value: "NORMAL"
                          }, null, _parent4, _scopeId3));
                          _push4(` Normal </label><label class="flex cursor-pointer items-center gap-2 text-sm"${_scopeId3}>`);
                          _push4(ssrRenderComponent(_component_UiRadioGroupItem, {
                            id: "priority-urgent",
                            value: "URGENT"
                          }, null, _parent4, _scopeId3));
                          ...
                          return [
                            createVNode("label", { class: "flex cursor-pointer items-center gap-2 text-sm" }, [
                              createVNode(_component_UiRadioGroupItem, {
                                id: "priority-normal",
                                value: "NORMAL"
                              }),
                    ...
                    _push3(`</div><div class="space-y-2"${_scopeId2}>`);
                    _push3(ssrRenderComponent(_component_UiLabel, { for: "deliveryNotes" }, {
                      default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                        if (_push4) {
                          _push4(`Delivery Notes`);
                        } else {
                          return [
                            createTextVNode("Delivery Notes")
                          ];
                        }
                      }),
                      _: 1
                    ...
                    _push3(ssrRenderComponent(_component_UiInput, {
                      id: "deliveryNotes",
                      modelValue: unref(form).deliveryNotes,
                      "onUpdate:modelValue": ($event) => unref(form).deliveryNotes = $event,
                      placeholder: "Optional"
                    }, null, _parent3, _scopeId2));
                    _push3(`</div><!--]-->`);
                  }
                  ...
                  if (unref(calculatedTotal) > 0) {
                    _push3(`<div class="rounded-lg bg-muted p-3 space-y-1"${_scopeId2}><div class="flex justify-between text-sm"${_scopeId2}><span${_scopeId2}>Total</span><span class="font-bold tabular-nums"${_scopeId2}>${ssrInterpolate(unref(calculatedTotal).toFixed(2))}</span></div>`);
                    if (unref(fulfillmentMethod) === "DIRECT") {
                      _push3(`<!--[--><div class="flex justify-between text-sm"${_scopeId2}><span${_scopeId2}>Paid</span><span class="tabular-nums text-green-600"${_scopeId2}>${ssrInterpolate((unref(form).paidAmount || 0).toFixed(2))}</span></div>`);
                      _push3(ssrRenderComponent(_component_UiSeparator, null, null, _parent3, _scopeId2));
                      _push3(`<div class="flex justify-between text-sm font-medium"${_scopeId2}><span${_scopeId2}>Remaining Due</span><span class="tabular-nums text-destructive"${_scopeId2}>${ssrInterpolate(unref(remainingDue).toFixed(2))}</span></div><!--]-->`);
                    } else {
                      _push3(`<!---->`);
                    }
                    _push3(`</div>`);
                  ...
                  return [
                    ...
                    unref(fulfillmentMethod) === "DIRECT" ? (openBlock(), createBlock(Fragment, { key: 0 }, [
                      createVNode("div", { class: "space-y-2" }, [
                      ...
                      createVNode("div", { class: "space-y-2" }, [
                        createVNode(_component_UiLabel, { for: "assignedDistributor" }, {
                          default: withCtx(() => [
                            createTextVNode("Assign Distributor *")
                          ]),
                          _: 1
                      ...
                      createVNode("div", { class: "space-y-2" }, [
                        createVNode(_component_UiLabel, { for: "expectedDeliveryDate" }, {
                          default: withCtx(() => [
                            createVNode("span", { class: "inline-flex items-center gap-1.5" }, [
                              createVNode(unref(CalendarDays), { class: "size-3.5" }),
                              createTextVNode(" Expected Delivery Date *")
                      ...
                      createVNode("div", { class: "space-y-2" }, [
                        createVNode(_component_UiLabel, { for: "deliveryNotes" }, {
                          default: withCtx(() => [
                            createTextVNode("Delivery Notes")
                          ]),
                          _: 1
      ...
      _push(ssrRenderComponent(_component_UiButton, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(` ${ssrInterpolate(unref(saving) ? "Creating..." : unref(fulfillmentMethod) === "DELIVERY" ? "Create Delivery Order" : "Create Sale")}`);
          } else {
            return [
              createVNode(unref(ShoppingCart), { class: "size-4" }),
              createTextVNode(" " + toDisplayString(unref(saving) ? "Creating..." : unref(fulfillmentMethod) === "DELIVERY" ? "Create Delivery Order" : "Create Sale"), 1)
            ];
          }
        }),
        _: 1
...
//# sourceMappingURL=new-BdKRB5wT.mjs.map
