...
import { _ as _sfc_main$a, a as _sfc_main$1$1, b as _sfc_main$3, c as _sfc_main$9, d as _sfc_main$7 } from './SelectValue-CvBB3u-2.mjs';
import { _ as __nuxt_component_1 } from './LoadingState-CjZdJj9x.mjs';
import { _ as _sfc_main$4 } from './index-BJ9JiLtz.mjs';
import { _ as _sfc_main$6, b as _sfc_main$1$2, c as _sfc_main$5, d as _sfc_main$3$1, a as _sfc_main$4$1 } from './CardTitle-CZp9i7Kv.mjs';
                  ...
                  default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                    if (_push3) {
                      ...
                      ssrRenderList(unref(selectedInvoice).items || [], (item) => {
                        _push3(`<div class="grid grid-cols-4 gap-2 py-2 text-sm border-b last:border-0"${_scopeId2}><span class="col-span-2 truncate"${_scopeId2}>${ssrInterpolate(item.product?.name || item.productId)}</span><span class="text-right"${_scopeId2}>${ssrInterpolate(Number(item.quantity).toFixed(1))}</span><span class="text-right font-medium"${_scopeId2}>${ssrInterpolate(Number(item.totalPrice).toFixed(2))}</span></div>`);
                      });
                      _push3(`<!--]--><div class="flex justify-between pt-2 text-sm font-semibold"${_scopeId2}><span${_scopeId2}>Total</span><span${_scopeId2}>${ssrInterpolate(Number(unref(selectedInvoice).totalAmount).toFixed(2))}</span></div>`);
                    } else {
                      return [
                        ...
                        (openBlock(true), createBlock(Fragment, null, renderList(unref(selectedInvoice).items || [], (item) => {
                          return openBlock(), createBlock("div", {
                            ...
                            createVNode("span", { class: "text-right" }, toDisplayString(Number(item.quantity).toFixed(1)), 1),
                            createVNode("span", { class: "text-right font-medium" }, toDisplayString(Number(item.totalPrice).toFixed(2)), 1)
                          ]);
                        }), 128)),
                        createVNode("div", { class: "flex justify-between pt-2 text-sm font-semibold" }, [
                          createVNode("span", null, "Total"),
                          createVNode("span", null, toDisplayString(Number(unref(selectedInvoice).totalAmount).toFixed(2)), 1)
                        ])
                      ];
                    }
                  }),
                  ...
                  default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                    if (_push3) {
                      ...
                      ssrRenderList(unref(selectedInvoice).payments || [], (p) => {
                        _push3(`<div class="flex items-center justify-between border-b py-2 text-sm last:border-0"${_scopeId2}><div${_scopeId2}><p class="font-medium"${_scopeId2}>${ssrInterpolate(p.paymentMethod)}</p><p class="text-xs text-muted-foreground"${_scopeId2}>${ssrInterpolate(new Date(p.createdAt).toLocaleDateString())}</p></div><span class="font-semibold text-green-600"${_scopeId2}>${ssrInterpolate(Number(p.amount).toFixed(2))}</span></div>`);
                      });
                      _push3(`<!--]--><div class="flex justify-between pt-2 text-sm border-t mt-2"${_scopeId2}><span class="text-muted-foreground"${_scopeId2}>Total Paid</span><span class="font-semibold"${_scopeId2}>${ssrInterpolate(Number(unref(selectedInvoice).paidAmount).toFixed(2))}</span></div>`);
                      if (unref(selectedInvoice).status !== "PAID") {
                        _push3(`<div class="flex justify-between text-sm"${_scopeId2}><span class="text-muted-foreground"${_scopeId2}>Remaining</span><span class="font-semibold text-red-600"${_scopeId2}>${ssrInterpolate(Number(unref(selectedInvoice).totalAmount - unref(selectedInvoice).paidAmount).toFixed(2))}</span></div>`);
                      } else {
                        _push3(`<!---->`);
                      }
                    } else {
                      return [
                        ...
                        (openBlock(true), createBlock(Fragment, null, renderList(unref(selectedInvoice).payments || [], (p) => {
                          return openBlock(), createBlock("div", {
                            ...
                            createVNode("span", { class: "font-semibold text-green-600" }, toDisplayString(Number(p.amount).toFixed(2)), 1)
                          ]);
                        }), 128)),
                        createVNode("div", { class: "flex justify-between pt-2 text-sm border-t mt-2" }, [
                          ...
                          createVNode("span", { class: "font-semibold" }, toDisplayString(Number(unref(selectedInvoice).paidAmount).toFixed(2)), 1)
                        ]),
                        unref(selectedInvoice).status !== "PAID" ? (openBlock(), createBlock("div", {
                          ...
                          createVNode("span", { class: "font-semibold text-red-600" }, toDisplayString(Number(unref(selectedInvoice).totalAmount - unref(selectedInvoice).paidAmount).toFixed(2)), 1)
                    ...
                    default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                      if (_push3) {
                        ...
                        _push3(ssrRenderComponent(_component_UiCardDescription, null, {
                          default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                            if (_push4) {
                              _push4(`Remaining: ${ssrInterpolate(Number(unref(selectedInvoice).totalAmount - unref(selectedInvoice).paidAmount).toFixed(2))}`);
                            } else {
                              return [
                                createTextVNode("Remaining: " + toDisplayString(Number(unref(selectedInvoice).totalAmount - unref(selectedInvoice).paidAmount).toFixed(2)), 1)
                              ];
                            }
                          }),
                          _: 1
...
//# sourceMappingURL=bills-CXlm8Gs0.mjs.map
