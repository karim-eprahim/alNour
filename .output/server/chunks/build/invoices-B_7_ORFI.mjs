...
import { _ as _sfc_main$1 } from './index-CaQj38bB.mjs';
import { _ as _sfc_main$2 } from './index-B-gxPDkl.mjs';
import { _ as _sfc_main$6, b as _sfc_main$1$1, c as _sfc_main$3, d as _sfc_main$3$1, a as _sfc_main$4 } from './CardTitle-D6ZW0MPQ.mjs';
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (unref(store).loading) {
        ...
        ssrRenderList(unref(store).invoices, (inv) => {
          ...
          _push(`</div><div class="mt-2 flex items-center justify-between text-sm"><span class="text-muted-foreground">Total: <strong>${ssrInterpolate(Number(inv.totalAmount).toFixed(2))}</strong></span><span class="text-muted-foreground">Paid: <strong>${ssrInterpolate(Number(inv.paidAmount).toFixed(2))}</strong></span></div>`);
                ...
                default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    ...
                    _push3(ssrRenderComponent(_component_UiCardDescription, null, {
                      default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                        if (_push4) {
                          _push4(` Total: ${ssrInterpolate(Number(unref(selectedInvoice).totalAmount).toFixed(2))} | Remaining: ${ssrInterpolate(Number(unref(selectedInvoice).totalAmount - unref(selectedInvoice).paidAmount).toFixed(2))}`);
                        } else {
                          return [
                            createTextVNode(" Total: " + toDisplayString(Number(unref(selectedInvoice).totalAmount).toFixed(2)) + " | Remaining: " + toDisplayString(Number(unref(selectedInvoice).totalAmount - unref(selectedInvoice).paidAmount).toFixed(2)), 1)
                          ];
                        }
                      }),
                      _: 1
                ...
                default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    ...
                    _push3(ssrRenderComponent(_component_UiInput, {
                      ...
                      min: "0",
                      step: "0.01",
                      max: Number(unref(selectedInvoice).totalAmount) - Number(unref(selectedInvoice).paidAmount),
                      class: "mt-1"
...
//# sourceMappingURL=invoices-B_7_ORFI.mjs.map
