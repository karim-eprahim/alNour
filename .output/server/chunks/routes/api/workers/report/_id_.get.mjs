import { d as defineEventHandler, g as getRouterParam, c as createError, f as getQuery } from '../../../../nitro/nitro.mjs';
...
const _id__get = defineEventHandler(async (event) => {
  ...
  return {
    report: {
      worker: { id: worker.id, name: worker.name, phone: worker.phone, role: worker.role, defaultDailyWage: ((_a = worker.defaultDailyWage) == null ? void 0 : _a.toNumber()) || 0, isActive: worker.isActive },
      attendanceSummary,
